...
class FeuParFeuEnv(ParallelEnv):
    ...
    def __init__(
        ...
        sumo_seed: Union[None, str] = None, # if str, it should be 'random'
    ...
    def seed(self, seed=None):
        """Define the seed of the environment"""
        _, self.sumo_seed = seeding.np_random(seed)
    ...
    def reset(self, seed=None, options=None):
        ...
        if seed is not None:
            self.sumo_seed = seed
        print(f"self.sumo_seed dans reset : {self.sumo_seed}")
        # start simulation
    ...
    def _compute_observations(self) -> dict:
        ...
        Returns:
            observations (dict): dict of the form {id_agent: observation}
        """
        observations = {}
